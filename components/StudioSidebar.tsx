    ...
    >
      ...
      <nav
        style={{
          flex: 1,
          overflowY: 'auto',
          padding: compact ? '12px 6px' : '12px 10px',
          display: 'flex',
          flexDirection: 'column',
          gap: 16,
        }}
              ...
              {items.map((item) => {
                ...
                return (
                  ...
                  >
                    <Icon
                      size={15}
                      style={{ flexShrink: 0, color: active ? SB.accent : 'inherit' }}
                    />
                    {!compact && (
                      <span
                        style={{
        ...
        >
          <div
            style={{
              ...
              height: 30,
              borderRadius: '50%',
              background: SB.accent + '30',
              border: `1px solid ${SB.accent}40`,
              display: 'grid',
              placeItems: 'center',
              flexShrink: 0,
              fontFamily: 'var(--font-display)',
