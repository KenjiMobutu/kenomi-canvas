-- ============================================================
-- Studio data tables: ventures, services, campaigns, analytics
-- ============================================================
...
CREATE POLICY "ventures_own" ON public.ventures FOR ALL USING (auth.uid() = user_id);
...
CREATE POLICY "services_own" ON public.services FOR ALL USING (auth.uid() = user_id);
...
CREATE POLICY "kpis_own" ON public.kpi_snapshots FOR ALL USING (auth.uid() = user_id);
...
CREATE POLICY "funnel_own" ON public.funnel_steps FOR ALL USING (auth.uid() = user_id);
