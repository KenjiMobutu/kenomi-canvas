...
export function evalRevenueTruthGate(input) {
  ...
  if (missing(input.attributedPaidRows)) failures.push('paid_truth_missing')
  if (missing(input.attributedCashCents)) failures.push('attributed_cash_truth_missing')
  if (missing(input.weeklyReviewsWithPaidTruth)) failures.push('weekly_review_paid_truth_missing')
