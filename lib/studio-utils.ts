...
export const AGENTS_DATA = [
  {
    ...
    code: 'SCT',
    role: 'Discovery',
    tagline: 'Reddit · PH · Trends · Gummysearch',
    model: 'Claude Code',
    color: '#22d3ee',
    sigil: '◬',
  },
  ...
  },
  {
    ...
    code: 'VAL',
    role: 'Scoring',
    tagline: 'TAM · CPC · SEO · concurrents',
    model: 'Ollama',
    color: '#a78bfa',
    sigil: '◇',
  },
  {
    ...
    code: 'BLD',
    role: 'Production',
    tagline: 'Landing · pricing · branding',
    model: 'Claude Code',
    color: '#34d399',
    sigil: '◮',
  },
  {
    ...
    code: 'PAY',
    role: 'Monetization',
    tagline: 'Stripe · checkout · webhooks',
    model: 'Stripe API',
    color: '#fbbf24',
    sigil: '◈',
  },
  {
    ...
    code: 'MKT',
    role: 'Distribution',
    tagline: 'LinkedIn · TikTok · SEO · ads',
    model: 'Ollama',
    color: '#e879f9',
    sigil: '✺',
  },
  {
    ...
    code: 'ANA',
    role: 'Telemetry',
    tagline: 'Trafic · revenu · CAC · rétention',
    model: 'Supabase',
    color: '#60a5fa',
    sigil: '◐',
  },
  {
    ...
    code: 'DEC',
    role: 'Command',
    tagline: 'Continue · Pivot · Stop · Scale',
    model: 'Claude Code',
    color: '#ff6a3d',
    sigil: '✦',
  },
